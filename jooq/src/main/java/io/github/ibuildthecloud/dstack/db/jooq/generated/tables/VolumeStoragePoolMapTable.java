...
public class VolumeStoragePoolMapTable extends org.jooq.impl.TableImpl<io.github.ibuildthecloud.dstack.db.jooq.generated.tables.records.VolumeStoragePoolMapRecord> {

	private static final long serialVersionUID = -100554071;

	/**
	 * The singleton instance of <code>dstack.volume_storage_pool_map</code>
	 */
	public static final io.github.ibuildthecloud.dstack.db.jooq.generated.tables.VolumeStoragePoolMapTable VOLUME_STORAGE_POOL_MAP = new io.github.ibuildthecloud.dstack.db.jooq.generated.tables.VolumeStoragePoolMapTable();
	...
	public VolumeStoragePoolMapTable() {
		super("volume_storage_pool_map", io.github.ibuildthecloud.dstack.db.jooq.generated.DstackTable.DSTACK);
	}
	...
	public VolumeStoragePoolMapTable(java.lang.String alias) {
		super(alias, io.github.ibuildthecloud.dstack.db.jooq.generated.DstackTable.DSTACK, io.github.ibuildthecloud.dstack.db.jooq.generated.tables.VolumeStoragePoolMapTable.VOLUME_STORAGE_POOL_MAP);
	}
	 ...
	 */
	@Override
	public io.github.ibuildthecloud.dstack.db.jooq.generated.tables.VolumeStoragePoolMapTable as(java.lang.String alias) {
		return new io.github.ibuildthecloud.dstack.db.jooq.generated.tables.VolumeStoragePoolMapTable(alias);
	}
}
