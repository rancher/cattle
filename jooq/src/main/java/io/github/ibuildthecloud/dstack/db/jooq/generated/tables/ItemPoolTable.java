...
public class ItemPoolTable extends org.jooq.impl.TableImpl<io.github.ibuildthecloud.dstack.db.jooq.generated.tables.records.ItemPoolRecord> {

	private static final long serialVersionUID = 142996536;

	/**
	 * The singleton instance of <code>dstack.item_pool</code>
	 */
	public static final io.github.ibuildthecloud.dstack.db.jooq.generated.tables.ItemPoolTable ITEM_POOL = new io.github.ibuildthecloud.dstack.db.jooq.generated.tables.ItemPoolTable();
	 ...
	 */
	public final org.jooq.TableField<io.github.ibuildthecloud.dstack.db.jooq.generated.tables.records.ItemPoolRecord, java.util.Map<String,Object>> DATA = createField("data", org.jooq.impl.SQLDataType.CLOB.length(16777215).asConvertedDataType(new io.github.ibuildthecloud.dstack.db.jooq.converter.DataConverter()), this);

	/**
	 * Create a <code>dstack.item_pool</code> table reference
	 */
	public ItemPoolTable() {
		super("item_pool", io.github.ibuildthecloud.dstack.db.jooq.generated.DstackTable.DSTACK);
	}
	...
	public ItemPoolTable(java.lang.String alias) {
		super(alias, io.github.ibuildthecloud.dstack.db.jooq.generated.DstackTable.DSTACK, io.github.ibuildthecloud.dstack.db.jooq.generated.tables.ItemPoolTable.ITEM_POOL);
	}
	 ...
	 */
	@Override
	public io.github.ibuildthecloud.dstack.db.jooq.generated.tables.ItemPoolTable as(java.lang.String alias) {
		return new io.github.ibuildthecloud.dstack.db.jooq.generated.tables.ItemPoolTable(alias);
	}
}
