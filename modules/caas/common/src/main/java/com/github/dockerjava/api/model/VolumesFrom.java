...
public class VolumesFrom {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof VolumesFrom) {
            ...
            return new EqualsBuilder().append(container, other.getContainer()).append(accessMode, other.getAccessMode()).isEquals();
        } else
    ...
    /**
     * Returns a string representation of this {@link VolumesFrom} suitable for
     * inclusion in a JSON message. The format is
     * <code>&lt;container&gt;:&lt;access mode&gt;</code>, like the argument in
     * {@link #parse(String)}.
     * 
