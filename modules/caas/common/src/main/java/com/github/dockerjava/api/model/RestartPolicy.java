 ...
 * <dt>on-failure</dt>
 * <dd>Restart the container if it exits with a non-zero exit code. Can also
 * accept an optional maximum restart count (e.g. on-failure:5).
 * <dd>
 * <dt>always</dt>
...
public class RestartPolicy {
     ...
     *            the maximum number of restarts. Set to <code>0</code> for
     *            unlimited retries.
     */
    ...
    /**
     * Returns a string representation of this {@link RestartPolicy}. The format
     * is <code>name[:count]</code>, like the argument in
     * {@link #parse(String)}.
     * 
    ...
    public boolean equals(Object obj) {
        if (obj instanceof RestartPolicy) {
            ...
            return new EqualsBuilder().append(maximumRetryCount, other.getMaximumRetryCount()).append(name, other.getName()).isEquals();
        } else
