...
public class Volumes {
    ...
    public static class Serializer extends JsonSerializer<Volumes> {
        ...
        @Override
        public void serialize(Volumes volumes, JsonGenerator jsonGen, SerializerProvider serProvider) throws IOException {
    ...
    public static class Deserializer extends JsonDeserializer<Volumes> {
        @Override
        public Volumes deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
