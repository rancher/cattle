 ...
 * is defined by its {@link #getPort() port number} and an
 * InternetProtocol. It can be published by Docker by
 * Ports#bind(ExposedPort, Binding) binding it to a host port,
...
public class ExposedPort {
    ...
    /**
     * Creates an {@link ExposedPort} for the given {@link #getPort() port
     * number} and {@link InternetProtocol#DEFAULT}.
     *
     * @param port
     *            the {@link #getPort() port number}
     */
     ...
     *
     * @param scheme
     *            the {@link #getScheme() scheme}, <code>tcp</code> or
     *            <code>udp</code>
     * @param port
     *            the {@link #getPort() port number}
    ...
    /**
     * @return the {@link InternetProtocol} of the {@link #getPort() port} that
    ...
    /**
     * @return the scheme (internet protocol), <code>tcp</code> or
     *         <code>udp</code>
    ...
    /**
     * Creates an {@link ExposedPort} for {@link InternetProtocol#TCP}. This is
     * a shortcut for
    ...
    /**
     * Creates an {@link ExposedPort} for {@link InternetProtocol#UDP}. This is
     * a shortcut for
    ...
    /**
     * Returns a string representation of this {@link ExposedPort} suitable for
     * inclusion in a JSON message. The format is <code>port/protocol</code>,
