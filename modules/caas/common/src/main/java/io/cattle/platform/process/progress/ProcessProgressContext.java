...
class ProcessProgressContext implements ProcessProgressInstance {
    ...
    public ProcessProgressContext(ProcessState processState, ObjectManager objectManager, EventService eventService) {
        super();
    ...
    public void init(ProcessState state) {
        ...
        progressState = value.as(ProcessProgressState.class);
