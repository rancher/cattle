...
public class HazelcastFactory {
    ...
    public HazelcastFactory(HazelcastDao hazelcastDao, DBDiscoveryFactory dbDiscoveryFactory, DBDiscovery dbDiscovery) {
        super();
        this.hazelcastDao = hazelcastDao;
        this.dbDiscoveryFactory = dbDiscoveryFactory;
        this.dbDiscovery = dbDiscovery;
    }
