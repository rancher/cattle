...
def test_container_registry_default(super_client, client, context,
    ...
    whitelist_value = 'index.docker.io,rancher,docker.io'
    ...
    uuid = "localhost.localdomain:5000/ubuntu:{}".format(random_num())
    ...
    default_value = 'localhost.localdomain:5000'
    whitelist_value = 'localhost.localdomain:5000,'\
                      'localhost.localdomain:5000, index.docker.io'
    whitelist_value = whitelist_value + ',rancher,docker.io'
    default_registry = admin_user_client.update(default_registry,
                                                value=default_value)
    wait_setting_active(admin_user_client, default_registry)
    whitelist_registries = admin_user_client.update(whitelist_registries,
    ...
    assert_fields(container, {
        "type": "container",
        "state": "stopped",
        "imageUuid": "localhost.localdomain:5000/ubuntu:v2",
        "firstRunning": None,
    })

    uuid = "localhost.localdomain:5001/ubuntu:{}".format(random_num())
...
def test_registries(super_client, client, context,
    ...
    uuid = "registry.com/repo/ubuntu:{}".format(random_num())
