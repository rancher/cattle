...
def create_valid_listener(admin_client):
...
def create_config_and_listener(admin_client):
    # create listener
    listener = create_valid_listener(admin_client)
    # create config
    config = admin_client.create_loadBalancerConfig(name=random_str())
    config = admin_client.wait_success(config)
...
def test_lb_config_add_listener(admin_client, super_client):
    config, listener = create_config_and_listener(admin_client)
