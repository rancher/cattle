...
public class AllocationCandidateIteratorTest {
    ...
    @Test
    public void test() {
        List<List<Pair<String,String>>> lists =
                AllocationCandidateIterator.traverse(Arrays.asList("a", "b", "c"),
                        new LinkedHashSet<String>(Arrays.asList("1", "2", "3" ,"4")));
        ...
        lists = AllocationCandidateIterator.traverse(Arrays.asList("a", "b"),
                    new LinkedHashSet<String>(Arrays.asList("1", "2", "3")));
