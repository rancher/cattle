...
public class Bootstrap implements Closeable {
    ...
    public static final String MAIN = "io.github.ibuildthecloud.dstack.launcher.Main";
    ...
    protected void setHomeAndEnv() throws IOException {
        String home = System.getenv("DSTACK_HOME");

        if ( home == null ) {
            home = System.getProperty("dstack.home");
        }

        if ( home == null ) {
            home = new File(System.getProperty("user.home"), ".dstack") + File.separator;
        }
        ...
        System.setProperty("dstack.home", home);
        ...
        System.out.println("[BOOTSTRAP] DSTACK_HOME=" + this.home.getAbsolutePath());
    }
    ...
    protected String getDstackId() throws IOException {
        ...
        try {
            ...
            while ( (entry = is.getNextJarEntry()) != null ) {
                ...
                try {
                    return ris.getManifest().getMainAttributes().getValue("X-dstack-id");
                } finally {
                    closeQuietly(ris);
                }
            }
    ...
    protected void determineLibDir(JarInputStream is) throws IOException {
        ...
        if ( version == null ) {
            System.err.println("No dstack version found in jar");
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            ...
            System.out.println("[BOOTSTRAP] Launching dStack from " + Arrays.toString(classpath));
    ...
    public static final void main(String... args) {
        try {
            System.out.println("[BOOTSTRAP] Starting dStack");
