...
public class SampleDataStartupV2 extends AbstractSampleData {
    ...
    protected void populatedData(Account system, List<Object> toCreate) {
        ...
        toCreate.add(createByUuid(NetworkService.class, "unmanaged-docker0-metadata-service", NETWORK_SERVICE.ACCOUNT_ID, system.getId(), NETWORK_SERVICE.KIND,
                NetworkServiceConstants.KIND_METADATA, NETWORK_SERVICE.NAME, "Meta data service for unmanaged docker0", NETWORK_SERVICE.NETWORK_ID, network
                        .getId(), NetworkServiceConstants.FIELD_CONFIG_DRIVE, true, NETWORK_SERVICE.STATE, CommonStatesConstants.REQUESTED));
