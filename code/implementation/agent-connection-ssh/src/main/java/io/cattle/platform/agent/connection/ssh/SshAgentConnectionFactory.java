...
import io.cattle.platform.agent.connection.ssh.connection.EofClosingTcpipServerChannel.EofClosingTcpipServerChannelFactory;
...
public class SshAgentConnectionFactory implements AgentConnectionFactory {
    ...
    protected synchronized SshClient getClient() {
        ...
        EofClosingTcpipServerChannelFactory factory = new EofClosingTcpipServerChannel.EofClosingTcpipServerChannelFactory(executorService);
        client.setChannelFactories(Arrays.<NamedFactory<Channel>> asList(factory));
