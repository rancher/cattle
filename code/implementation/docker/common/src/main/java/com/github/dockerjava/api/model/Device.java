...
public class Device {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Device) {
            ...
            return new EqualsBuilder().append(cGroupPermissions, other.getcGroupPermissions()).append(pathInContainer, other.getPathInContainer()).append(
                    pathOnHost, other.getPathOnHost()).isEquals();
        } else
