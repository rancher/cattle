...
public class SimulatorConfigUpdateDownloadHandler implements AgentSimulatorEventProcessor {

    private static final Logger log = LoggerFactory.getLogger(SimulatorConfigUpdateDownloadHandler.class);
