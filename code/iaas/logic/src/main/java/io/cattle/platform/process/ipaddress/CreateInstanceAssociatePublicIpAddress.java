...
public class CreateInstanceAssociatePublicIpAddress extends AbstractObjectProcessLogic implements ProcessPostListener, Priority {
    ...
    public HandlerResult handle(ProcessState state, ProcessInstance process) {
        ...
        if (ip == null) {
            ...
            ip = ipAddressDao.createIpAddressFromPool(pool, ObjectMetaDataManager.UUID_FIELD, uuid, ObjectMetaDataManager.CAPABILITIES_FIELD,
                    Collections.emptyList(), ObjectMetaDataManager.DATA_FIELD, data);
        }
