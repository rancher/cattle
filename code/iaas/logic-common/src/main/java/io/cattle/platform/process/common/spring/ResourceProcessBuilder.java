...
public class ResourceProcessBuilder {
    ...
    public ResourceProcessBuilder(Map<String, ProcessDefinition> processDefinition, ObjectManager objectManager, JsonMapper jsonMapper,
            ProcessRecordDao processRecordDao, ExtensionManager extensionManager) {
    ...
    public void build() {
        ...
        GenericResourceProcessDefinition def = new GenericResourceProcessDefinition(name, extensionManager, resourceType, resourceStatesDefinition,
