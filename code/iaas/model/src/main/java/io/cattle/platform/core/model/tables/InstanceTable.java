...
public class InstanceTable extends org.jooq.impl.TableImpl<io.cattle.platform.core.model.tables.records.InstanceRecord> {
	...
	private static final long serialVersionUID = 1540194664;
	 ...
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.util.Map<String,Object>> DATA = createField("data", org.jooq.impl.SQLDataType.CLOB.length(16777215).asConvertedDataType(new io.cattle.platform.db.jooq.converter.DataConverter()), this, "");
	 ...
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.lang.String> HEALTH_STATE = createField("health_state", org.jooq.impl.SQLDataType.VARCHAR.length(128), this, "");

	/**
	 * The column <code>cattle.instance.start_count</code>.
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.lang.Long> START_COUNT = createField("start_count", org.jooq.impl.SQLDataType.BIGINT, this, "");
	 ...
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.lang.Long> SERVICE_INDEX_ID = createField("service_index_id", org.jooq.impl.SQLDataType.BIGINT, this, "");

	/**
	 * The column <code>cattle.instance.dns_internal</code>.
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.lang.String> DNS_INTERNAL = createField("dns_internal", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");
	 ...
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.lang.Long> MEMORY_RESERVATION = createField("memory_reservation", org.jooq.impl.SQLDataType.BIGINT, this, "");

	/**
	 * The column <code>cattle.instance.milli_cpu_reservation</code>.
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.lang.Long> MILLI_CPU_RESERVATION = createField("milli_cpu_reservation", org.jooq.impl.SQLDataType.BIGINT, this, "");

	/**
	 * The column <code>cattle.instance.system</code>.
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.lang.Boolean> SYSTEM = createField("system", org.jooq.impl.SQLDataType.BIT.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>cattle.instance.service_id</code>.
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.lang.Long> SERVICE_ID = createField("service_id", org.jooq.impl.SQLDataType.BIGINT, this, "");

	/**
	 * The column <code>cattle.instance.environment_id</code>.
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.lang.Long> STACK_ID = createField("environment_id", org.jooq.impl.SQLDataType.BIGINT, this, "");

	/**
	 * The column <code>cattle.instance.replacement_for</code>.
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.lang.Long> REPLACEMENT_FOR = createField("replacement_for", org.jooq.impl.SQLDataType.BIGINT, this, "");

	/**
	 * The column <code>cattle.instance.deployment_unit_id</code>.
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.lang.Long> DEPLOYMENT_UNIT_ID = createField("deployment_unit_id", org.jooq.impl.SQLDataType.BIGINT, this, "");

	/**
	 * The column <code>cattle.instance.revision_id</code>.
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.lang.Long> REVISION_ID = createField("revision_id", org.jooq.impl.SQLDataType.BIGINT, this, "");

	/**
	 * The column <code>cattle.instance.previous_revision_id</code>.
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.lang.Long> PREVIOUS_REVISION_ID = createField("previous_revision_id", org.jooq.impl.SQLDataType.BIGINT, this, "");

	/**
	 * The column <code>cattle.instance.service_revision_id</code>.
	 */
	public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.InstanceRecord, java.lang.Long> SERVICE_REVISION_ID = createField("service_revision_id", org.jooq.impl.SQLDataType.BIGINT, this, "");
	...
	public java.util.List<org.jooq.ForeignKey<io.cattle.platform.core.model.tables.records.InstanceRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<io.cattle.platform.core.model.tables.records.InstanceRecord, ?>>asList(io.cattle.platform.core.model.Keys.FK_INSTANCE__ACCOUNT_ID, io.cattle.platform.core.model.Keys.FK_INSTANCE__IMAGE_ID, io.cattle.platform.core.model.Keys.FK_INSTANCE__ZONE_ID, io.cattle.platform.core.model.Keys.FK_INSTANCE__AGENT_ID, io.cattle.platform.core.model.Keys.FK_INSTANCE__REGISTRY_CREDENTIAL_ID, io.cattle.platform.core.model.Keys.FK_INSTANCE__INSTANCE_ID, io.cattle.platform.core.model.Keys.FK_INSTANCE__SERVICE_INDEX_ID, io.cattle.platform.core.model.Keys.FK_INSTANCE__SERVICE_ID, io.cattle.platform.core.model.Keys.FK_INSTANCE__ENVIRONMENT_ID, io.cattle.platform.core.model.Keys.FK_INSTANCE__REPLACEMENT_FOR, io.cattle.platform.core.model.Keys.FK_INSTANCE__DEPLOYMENT_UNIT_ID, io.cattle.platform.core.model.Keys.FK_INSTANCE__REVISION_ID, io.cattle.platform.core.model.Keys.FK_INSTANCE__PREVIOUS_REVISION_ID, io.cattle.platform.core.model.Keys.FK_INSTANCE__SERVICE_REVISION_ID);
	}
