...
public class InstanceRecord extends UpdatableRecordImpl<InstanceRecord> implements TableRecordJaxb, Instance {
    ...
    private static final long serialVersionUID = -2006049218;
     ...
     */
    public InstanceRecord(Long id, String name, Long accountId, String kind, String uuid, String description, String state, Date created, Date removed, Date removeTime, Map<String,Object> data, String allocationState, Long compute, Long memoryMb, Long imageId, String hostname, String instanceTriggeredStop, Long agentId, String domain, Date firstRunning, String token, String userdata, Long registryCredentialId, String externalId, Boolean nativeContainer, Long networkContainerId, String healthState, Long startCount, Long createIndex, String deploymentUnitUuid, String version, Date healthUpdated, Long serviceIndexId, String dnsInternal, String dnsSearchInternal, Long memoryReservation, Long milliCpuReservation, Boolean system, Long serviceId, Long environmentId, Long deploymentUnitId, Long revisionId, Boolean desired) {
        super(InstanceTable.INSTANCE);
        ...
        set(9, removeTime);
        set(10, data);
        set(11, allocationState);
        set(12, compute);
        set(13, memoryMb);
        set(14, imageId);
        set(15, hostname);
        set(16, instanceTriggeredStop);
        set(17, agentId);
        set(18, domain);
        set(19, firstRunning);
        set(20, token);
        set(21, userdata);
        set(22, registryCredentialId);
        set(23, externalId);
        set(24, nativeContainer);
        set(25, networkContainerId);
        set(26, healthState);
        set(27, startCount);
        set(28, createIndex);
        set(29, deploymentUnitUuid);
        set(30, version);
        set(31, healthUpdated);
        set(32, serviceIndexId);
        set(33, dnsInternal);
        set(34, dnsSearchInternal);
        set(35, memoryReservation);
        set(36, milliCpuReservation);
        set(37, system);
        set(38, serviceId);
        set(39, environmentId);
        set(40, deploymentUnitId);
        set(41, revisionId);
        set(42, desired);
    }
}
