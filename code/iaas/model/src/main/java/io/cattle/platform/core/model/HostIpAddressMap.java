...
public interface HostIpAddressMap extends java.io.Serializable {
	...
	/**
	 * Load data from another generated Record/POJO implementing the common interface HostIpAddressMap
	 */
	public void from(io.cattle.platform.core.model.HostIpAddressMap from);

	/**
	 * Copy data into another generated Record/POJO implementing the common interface HostIpAddressMap
	 */
