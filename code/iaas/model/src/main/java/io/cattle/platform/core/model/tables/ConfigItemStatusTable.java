...
public class ConfigItemStatusTable extends org.jooq.impl.TableImpl<io.cattle.platform.core.model.tables.records.ConfigItemStatusRecord> {
    ...
    private static final long serialVersionUID = 1474885214;
     ...
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.ConfigItemStatusRecord, java.lang.Long> ID = createField("id",
            org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>cattle.config_item_status.name</code>.
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.ConfigItemStatusRecord, java.lang.String> NAME = createField("name",
     ...
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.ConfigItemStatusRecord, java.lang.Long> REQUESTED_VERSION = createField(
            "requested_version", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaulted(true), this, "");

    /**
     * The column <code>cattle.config_item_status.applied_version</code>.
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.ConfigItemStatusRecord, java.lang.Long> APPLIED_VERSION = createField(
            "applied_version", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaulted(true), this, "");

    /**
     * The column <code>cattle.config_item_status.source_version</code>.
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.ConfigItemStatusRecord, java.lang.String> SOURCE_VERSION = createField(
            "source_version", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

    /**
     * The column <code>cattle.config_item_status.requested_updated</code>.
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.ConfigItemStatusRecord, java.util.Date> REQUESTED_UPDATED = createField(
            "requested_updated",
     ...
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.ConfigItemStatusRecord, java.util.Date> APPLIED_UPDATED = createField(
            "applied_updated", org.jooq.impl.SQLDataType.TIMESTAMP.asConvertedDataType(new io.cattle.platform.db.jooq.converter.DateConverter()), this, "");

    /**
     * The column <code>cattle.config_item_status.agent_id</code>.
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.ConfigItemStatusRecord, java.lang.Long> AGENT_ID = createField("agent_id",
    ...
    public java.util.List<org.jooq.UniqueKey<io.cattle.platform.core.model.tables.records.ConfigItemStatusRecord>> getKeys() {
        return java.util.Arrays.<org.jooq.UniqueKey<io.cattle.platform.core.model.tables.records.ConfigItemStatusRecord>> asList(
                io.cattle.platform.core.model.Keys.KEY_CONFIG_ITEM_STATUS_PRIMARY,
                io.cattle.platform.core.model.Keys.KEY_CONFIG_ITEM_STATUS_IDX_CONFIG_ITEM_STATUS_NAME_AGENT_ID);
    }
    ...
    public java.util.List<org.jooq.ForeignKey<io.cattle.platform.core.model.tables.records.ConfigItemStatusRecord, ?>> getReferences() {
        return java.util.Arrays.<org.jooq.ForeignKey<io.cattle.platform.core.model.tables.records.ConfigItemStatusRecord, ?>> asList(
                io.cattle.platform.core.model.Keys.FK_CONFIG_ITEM__NAME, io.cattle.platform.core.model.Keys.FK_CONFIG_ITEM__AGENT_ID);
    }
