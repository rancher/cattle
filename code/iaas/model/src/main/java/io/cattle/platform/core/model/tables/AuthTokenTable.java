...
public class AuthTokenTable extends org.jooq.impl.TableImpl<io.cattle.platform.core.model.tables.records.AuthTokenRecord> {
	...
	private static final long serialVersionUID = -1111251379;
	...
	public java.util.List<org.jooq.UniqueKey<io.cattle.platform.core.model.tables.records.AuthTokenRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<io.cattle.platform.core.model.tables.records.AuthTokenRecord>>asList(io.cattle.platform.core.model.Keys.KEY_AUTH_TOKEN_PRIMARY, io.cattle.platform.core.model.Keys.KEY_AUTH_TOKEN_KEY);
	}
