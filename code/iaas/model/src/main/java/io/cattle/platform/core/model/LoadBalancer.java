...
public interface LoadBalancer extends java.io.Serializable {
	...
	/**
	 * Load data from another generated Record/POJO implementing the common interface LoadBalancer
	 */
	public void from(io.cattle.platform.core.model.LoadBalancer from);

	/**
	 * Copy data into another generated Record/POJO implementing the common interface LoadBalancer
	 */
