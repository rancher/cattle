...
public class IpAddressNicMapTable extends org.jooq.impl.TableImpl<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord> {
     ...
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord, java.lang.Long> ID = createField("id",
            org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>cattle.ip_address_nic_map.name</code>.
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord, java.lang.String> NAME = createField("name",
            org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

    /**
     * The column <code>cattle.ip_address_nic_map.kind</code>.
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord, java.lang.String> KIND = createField("kind",
            org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");

    /**
     * The column <code>cattle.ip_address_nic_map.uuid</code>.
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord, java.lang.String> UUID = createField("uuid",
     ...
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord, java.lang.String> DESCRIPTION = createField(
            "description", org.jooq.impl.SQLDataType.VARCHAR.length(1024), this, "");

    /**
     * The column <code>cattle.ip_address_nic_map.state</code>.
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord, java.lang.String> STATE = createField("state",
            org.jooq.impl.SQLDataType.VARCHAR.length(128).nullable(false), this, "");

    /**
     * The column <code>cattle.ip_address_nic_map.created</code>.
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord, java.util.Date> CREATED = createField("created",
     ...
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord, java.util.Date> REMOVED = createField("removed",
            org.jooq.impl.SQLDataType.TIMESTAMP.asConvertedDataType(new io.cattle.platform.db.jooq.converter.DateConverter()), this, "");

    /**
     * The column <code>cattle.ip_address_nic_map.remove_time</code>.
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord, java.util.Date> REMOVE_TIME = createField(
     ...
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord, java.util.Map<String, Object>> DATA = createField(
     ...
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord, java.lang.Long> IP_ADDRESS_ID = createField(
            "ip_address_id", org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>cattle.ip_address_nic_map.nic_id</code>.
     */
    public final org.jooq.TableField<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord, java.lang.Long> NIC_ID = createField("nic_id",
    ...
    public java.util.List<org.jooq.UniqueKey<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord>> getKeys() {
        return java.util.Arrays.<org.jooq.UniqueKey<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord>> asList(
                io.cattle.platform.core.model.Keys.KEY_IP_ADDRESS_NIC_MAP_PRIMARY,
                io.cattle.platform.core.model.Keys.KEY_IP_ADDRESS_NIC_MAP_IDX_IP_ADDRESS_NIC_MAP_UUID);
    }
    ...
    public java.util.List<org.jooq.ForeignKey<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord, ?>> getReferences() {
        return java.util.Arrays.<org.jooq.ForeignKey<io.cattle.platform.core.model.tables.records.IpAddressNicMapRecord, ?>> asList(
                io.cattle.platform.core.model.Keys.FK_IP_ADDRESS_NIC_MAP__IP_ADDRESS_ID, io.cattle.platform.core.model.Keys.FK_IP_ADDRESS_NIC_MAP__NIC_ID);
    }
