...
public interface NetworkService extends java.io.Serializable {
	...
	/**
	 * Load data from another generated Record/POJO implementing the common interface NetworkService
	 */
	public void from(io.cattle.platform.core.model.NetworkService from);

	/**
	 * Copy data into another generated Record/POJO implementing the common interface NetworkService
	 */
