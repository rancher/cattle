...
public class ServiceDiscoveryConfigItem {
    ...
    public static final ServiceDiscoveryConfigItem BLKIOWEIGHT = new ServiceDiscoveryConfigItem("blkioWeight", "blkio_weight", false);
    public static final ServiceDiscoveryConfigItem CGROUPPARENT = new ServiceDiscoveryConfigItem("cgroupParent", "cgroup_parent", false);
    public static final ServiceDiscoveryConfigItem CPUPERIOD = new ServiceDiscoveryConfigItem("cpuPeriod", "cpu_period", false);
    public static final ServiceDiscoveryConfigItem CPUQUOTA = new ServiceDiscoveryConfigItem("cpuQuota", "cpu_quota", false);
    public static final ServiceDiscoveryConfigItem CPUSETMEMS = new ServiceDiscoveryConfigItem("cpuSetMems", "cpuset_mems", false);
    public static final ServiceDiscoveryConfigItem DNSOPT = new ServiceDiscoveryConfigItem("dnsOpt", "dns_opt", false);
    public static final ServiceDiscoveryConfigItem GROUPADD = new ServiceDiscoveryConfigItem("groupAdd", "groud_add", false);
    public static final ServiceDiscoveryConfigItem KERNELMEMORY = new ServiceDiscoveryConfigItem("kernelMemory", "kernel_memory", false);
    public static final ServiceDiscoveryConfigItem MEMORYSWAPPINESS = new ServiceDiscoveryConfigItem("memorySwappiness", "memory_swappiness", false);
    public static final ServiceDiscoveryConfigItem OOMKILLDISABLE = new ServiceDiscoveryConfigItem("oomKillDisable", "oom_kill_disable", false);
    public static final ServiceDiscoveryConfigItem SHMSIZE = new ServiceDiscoveryConfigItem("shmSize", "shm_size", false);
    public static final ServiceDiscoveryConfigItem TMPFS = new ServiceDiscoveryConfigItem("tmpfs", "tmpfs", false);
    public static final ServiceDiscoveryConfigItem UTS = new ServiceDiscoveryConfigItem("uts", "uts", false);
    public static final ServiceDiscoveryConfigItem STOPSIGNAL = new ServiceDiscoveryConfigItem("stopSignal", "stop_signal", false);
    public static final ServiceDiscoveryConfigItem STORAGEOPT = new ServiceDiscoveryConfigItem("storageOpt", "storage_opt", false);
    public static final ServiceDiscoveryConfigItem OOMSCOREADJ = new ServiceDiscoveryConfigItem("oomScoreAdj", "oom_score_adj", false);
    public static final ServiceDiscoveryConfigItem ULIMITS = new ServiceDiscoveryConfigItem("ulimits", "ulimits", false);
    public static final ServiceDiscoveryConfigItem HEALTHCMD = new ServiceDiscoveryConfigItem("healthCmd", "health_cmd", false);
    public static final ServiceDiscoveryConfigItem HEALTHINTERVAL = new ServiceDiscoveryConfigItem("healthInterval", "health_interval", false);
    public static final ServiceDiscoveryConfigItem HEALTHTIMEOUT = new ServiceDiscoveryConfigItem("healthTimeout", "health_timeout", false);
    public static final ServiceDiscoveryConfigItem HEALTHRETRIES = new ServiceDiscoveryConfigItem("healthRetries", "health_retries", false);
    public static final ServiceDiscoveryConfigItem SYSCTLS = new ServiceDiscoveryConfigItem("sysctls", "sysctls", false);
    public static final ServiceDiscoveryConfigItem IPCMODE = new ServiceDiscoveryConfigItem("ipcMode", "ipc_mode", false);
