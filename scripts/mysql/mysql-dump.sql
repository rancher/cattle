...
INSERT INTO `DATABASECHANGELOG` VALUES ('dump1','rancher (generated)','db/core-200.xml','2017-07-08 00:35:44',1,'EXECUTED','7:926f478dbdd71a5844aaedba1179905a','createTable tableName=account; createTable tableName=agent; createTable tableName=audit_log; createTable tableName=auth_token; createTable tableName=catalog; createTable tableName=catalog_category; createTable tableName=catalog_file; createTable t...','',NULL,'3.5.3',NULL,NULL,'9499300040');
...
CREATE TABLE `deployment_unit` (
  ...
  CONSTRAINT `fk_deployment_unit__environment_id` FOREIGN KEY (`environment_id`) REFERENCES `environment` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `host` (
  ...
  CONSTRAINT `fk_host__environment_id` FOREIGN KEY (`environment_id`) REFERENCES `environment` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `host_template` (
  ...
  CONSTRAINT `fk_host_template__account_id` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `instance` (
  ...
  CONSTRAINT `fk_instance__environment_id` FOREIGN KEY (`environment_id`) REFERENCES `environment` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `scheduled_upgrade` (
  ...
  CONSTRAINT `fk_scheduled_upgrade__environment_id` FOREIGN KEY (`environment_id`) REFERENCES `environment` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `secret` (
  ...
  CONSTRAINT `fk_secret__environment_id` FOREIGN KEY (`environment_id`) REFERENCES `environment` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-07-08  0:36:09
