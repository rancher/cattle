...
CREATE DATABASE IF NOT EXISTS cattle_old COLLATE = 'utf8_general_ci' CHARACTER SET = 'utf8';
...
GRANT ALL ON cattle_old.* TO 'cattle'@'%' IDENTIFIED BY 'cattle';
GRANT ALL ON cattle_old.* TO 'cattle'@'localhost' IDENTIFIED BY 'cattle';
