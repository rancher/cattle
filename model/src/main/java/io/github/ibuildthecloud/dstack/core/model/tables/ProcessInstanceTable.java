...
public class ProcessInstanceTable extends org.jooq.impl.TableImpl<io.github.ibuildthecloud.dstack.core.model.tables.records.ProcessInstanceRecord> {
	 ...
	 */
	public static final io.github.ibuildthecloud.dstack.core.model.tables.ProcessInstanceTable PROCESS_INSTANCE = new io.github.ibuildthecloud.dstack.core.model.tables.ProcessInstanceTable();

	/**
	 * The class holding records for this type
	 */
	@Override
	public java.lang.Class<io.github.ibuildthecloud.dstack.core.model.tables.records.ProcessInstanceRecord> getRecordType() {
		return io.github.ibuildthecloud.dstack.core.model.tables.records.ProcessInstanceRecord.class;
	}
	 ...
	 */
	@Override
	public org.jooq.Identity<io.github.ibuildthecloud.dstack.core.model.tables.records.ProcessInstanceRecord, java.lang.Long> getIdentity() {
		return io.github.ibuildthecloud.dstack.core.model.Keys.IDENTITY_PROCESS_INSTANCE;
	}
	 ...
	 */
	@Override
	public org.jooq.UniqueKey<io.github.ibuildthecloud.dstack.core.model.tables.records.ProcessInstanceRecord> getPrimaryKey() {
		return io.github.ibuildthecloud.dstack.core.model.Keys.KEY_PROCESS_INSTANCE_PRIMARY;
	}
	 ...
	 */
	@Override
	public java.util.List<org.jooq.UniqueKey<io.github.ibuildthecloud.dstack.core.model.tables.records.ProcessInstanceRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<io.github.ibuildthecloud.dstack.core.model.tables.records.ProcessInstanceRecord>>asList(io.github.ibuildthecloud.dstack.core.model.Keys.KEY_PROCESS_INSTANCE_PRIMARY);
	}
	 ...
	 */
	@Override
	public io.github.ibuildthecloud.dstack.core.model.tables.ProcessInstanceTable as(java.lang.String alias) {
		return new io.github.ibuildthecloud.dstack.core.model.tables.ProcessInstanceTable(alias, this);
	}

	/**
	 * Rename this table
	 */
	public io.github.ibuildthecloud.dstack.core.model.tables.ProcessInstanceTable rename(java.lang.String name) {
		return new io.github.ibuildthecloud.dstack.core.model.tables.ProcessInstanceTable(name, null);
	}
}
