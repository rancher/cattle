...
public class AgentTable extends org.jooq.impl.TableImpl<io.github.ibuildthecloud.dstack.core.model.tables.records.AgentRecord> {
	...
	private static final long serialVersionUID = 1855306292;
	 ...
	 */
	public final org.jooq.TableField<io.github.ibuildthecloud.dstack.core.model.tables.records.AgentRecord, java.sql.Timestamp> CREATED = createField("created", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this);
	 ...
	 */
	public AgentTable() {
		super("agent", io.github.ibuildthecloud.dstack.core.model.DstackTable.DSTACK);
	}
	...
	public AgentTable(java.lang.String alias) {
		super(alias, io.github.ibuildthecloud.dstack.core.model.DstackTable.DSTACK, io.github.ibuildthecloud.dstack.core.model.tables.AgentTable.AGENT);
	}
	...
	public io.github.ibuildthecloud.dstack.core.model.tables.AgentTable as(java.lang.String alias) {
		return new io.github.ibuildthecloud.dstack.core.model.tables.AgentTable(alias);
	}
}
