...
public interface ChangelogLock extends java.io.Serializable {
	...
	/**
	 * Load data from another generated Record/POJO implementing the common interface ChangelogLock
	 */
	public void from(io.github.ibuildthecloud.dstack.core.model.ChangelogLock from);

	/**
	 * Copy data into another generated Record/POJO implementing the common interface ChangelogLock
	 */
