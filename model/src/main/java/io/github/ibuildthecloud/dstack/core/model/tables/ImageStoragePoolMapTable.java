...
public class ImageStoragePoolMapTable extends org.jooq.impl.TableImpl<io.github.ibuildthecloud.dstack.core.model.tables.records.ImageStoragePoolMapRecord> {
	...
	private static final long serialVersionUID = 1554437421;
	 ...
	 */
	public final org.jooq.TableField<io.github.ibuildthecloud.dstack.core.model.tables.records.ImageStoragePoolMapRecord, java.lang.Long> TEMPLATE_ID = createField("template_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this);
	 ...
	 */
	public final org.jooq.TableField<io.github.ibuildthecloud.dstack.core.model.tables.records.ImageStoragePoolMapRecord, java.lang.String> PROGRESS = createField("progress", org.jooq.impl.SQLDataType.VARCHAR.length(255), this);

	/**
	 * The column <code>dstack.image_storage_pool_map.resource_state</code>. 
	 */
	public final org.jooq.TableField<io.github.ibuildthecloud.dstack.core.model.tables.records.ImageStoragePoolMapRecord, java.lang.String> RESOURCE_STATE = createField("resource_state", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this);

	/**
	 * The column <code>dstack.image_storage_pool_map.location</code>. 
	 */
	public final org.jooq.TableField<io.github.ibuildthecloud.dstack.core.model.tables.records.ImageStoragePoolMapRecord, java.lang.String> LOCATION = createField("location", org.jooq.impl.SQLDataType.VARCHAR.length(255), this);
	 ...
	 */
	public final org.jooq.TableField<io.github.ibuildthecloud.dstack.core.model.tables.records.ImageStoragePoolMapRecord, java.sql.Timestamp> BILLING_START = createField("billing_start", org.jooq.impl.SQLDataType.TIMESTAMP, this);

	/**
	 * The column <code>dstack.image_storage_pool_map.billing_end</code>. 
	 */
	public final org.jooq.TableField<io.github.ibuildthecloud.dstack.core.model.tables.records.ImageStoragePoolMapRecord, java.sql.Timestamp> BILLING_END = createField("billing_end", org.jooq.impl.SQLDataType.TIMESTAMP, this);
	 ...
	 */
	public final org.jooq.TableField<io.github.ibuildthecloud.dstack.core.model.tables.records.ImageStoragePoolMapRecord, java.sql.Timestamp> RESOURCE_REMOVE_SCHEDULE = createField("resource_remove_schedule", org.jooq.impl.SQLDataType.TIMESTAMP, this);

	/**
	 * The column <code>dstack.image_storage_pool_map.resource_removed</code>. 
	 */
	public final org.jooq.TableField<io.github.ibuildthecloud.dstack.core.model.tables.records.ImageStoragePoolMapRecord, java.sql.Timestamp> RESOURCE_REMOVED = createField("resource_removed", org.jooq.impl.SQLDataType.TIMESTAMP, this);
	...
	public java.util.List<org.jooq.ForeignKey<io.github.ibuildthecloud.dstack.core.model.tables.records.ImageStoragePoolMapRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<io.github.ibuildthecloud.dstack.core.model.tables.records.ImageStoragePoolMapRecord, ?>>asList(io.github.ibuildthecloud.dstack.core.model.Keys.FK_TEMPLATE_STORAGE_POOL_MAP_TEMPLATE_ID, io.github.ibuildthecloud.dstack.core.model.Keys.FK_TEMPLATE_STORAGE_POOL_MAP_STORAGE_POOL_ID);
	}
